...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (typedEl) {
    new TypeWriter('typedText', [
      'Transformo dados em decisões de design.',
      'Conecto psicologia de usuário a negócios.',
      'Construo sistemas que retêm e convertem.',
      'Product-Led Growth com design de alto padrão.',
    ], 55);
  }
